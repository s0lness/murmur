...
The division of labor underneath — **LLM as preference oracle, deterministic engine as the
combinatorial core, human as the gate** — is the thing that kept proving itself; see
